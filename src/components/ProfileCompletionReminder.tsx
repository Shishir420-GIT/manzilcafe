  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -50 }}
        className="fixed top-20 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-md mx-auto px-4"
      >
        <div className="bg-gradient-to-r from-golden-accent to-orange-accent rounded-xl shadow-2xl border border-golden-accent/30 overflow-hidden">
          <div className="p-4">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-semibold text-text-inverse mb-1">
                  Welcome to Manziil Café, {user.name}! ☕
                </h3>
                <p className="text-text-inverse/90 text-sm mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex items-center space-x-2 bg-white/20 hover:bg-white/30 text-text-inverse px-4 py-2 rounded-lg font-medium transition-colors backdrop-blur-sm"
                  >
                  ...
                  <button
                    ...
                    className="text-text-inverse/80 hover:text-text-inverse px-3 py-2 rounded-lg font-medium transition-colors"
                  >
                    Maybe Later
                  </button>
                </div>
